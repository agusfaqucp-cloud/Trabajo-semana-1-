...
| 4 | Diseño de UX inconsistente entre la vista del recepcionista y la del paciente | Diseño / UX | 3 | 3 | 9 | 🟠 ALTO | Mitigar | Alonso define guía de estilos y componentes reutilizables en semana 1. Revisión cruzada antes de codificar pantallas. | Ibarra (UX Lead) | Activo |
