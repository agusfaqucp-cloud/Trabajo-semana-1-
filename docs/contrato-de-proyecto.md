...
A continuación se detallan los integrantes del equipo con sus roles asignados para este proyecto. La asignación de roles se realizó en la primera reunión de kick-off considerando las habilidades previas de cada integrante, sus preferencias declaradas y la necesidad de cobertura equilibrada de las distintas áreas del sistema.

Nombre completo	Rol	Responsabilidades principales
...
Nota: El rol de Scrum Master en contexto Kanban actúa como facilitador del flujo, responsable de que el tablero esté actualizado, de eliminar bloqueos y de comunicar el estado del proyecto al equipo docente. No implica gestión jerárquica sino coordinación horizontal.

4. Acuerdos de trabajo del equipo

Los acuerdos establecidos a continuación fueron discutidos y aceptados por todos los integrantes en la reunión de kick-off. Su cumplimiento es responsabilidad compartida y el Scrum Master hará seguimiento semanal de su aplicación.

Horarios y disponibilidad
El equipo acordó una reunión de sincronización semanal los días miércoles de 19:00 a 20:00 (hora de Argentina), de modalidad virtual vía Discord. Esta reunión no es una daily standup sino una revisión del tablero: se revisa qué avanzó, qué está bloqueado y qué entra en la semana siguiente. Las decisiones técnicas urgentes pueden discutirse de forma asíncrona en el canal de WhatsApp o en los comentarios de las tarjetas de Trello. Fuera del horario de reunión, cada integrante trabaja según su disponibilidad personal, con el compromiso de mover las tarjetas del tablero dentro de las 24 horas de completar una tarea.
...
•	GitHub + Trello: toda comunicación relacionada con el código se realiza mediante pull requests y comentarios en commits (GitHub), mientras que la gestión de tareas y el tablero Kanban se gestionan en Trello con comentarios por tarjeta.

Se acordó que las decisiones tomadas en WhatsApp o Discord que afecten al proyecto deben quedar registradas en Trello como comentario de la tarjeta correspondiente, para garantizar trazabilidad y que ningún integrante quede fuera de contexto.

Frecuencia y convención de commits
El equipo acordó realizar commits pequeños y frecuentes, con un mínimo de un commit por sesión de trabajo, evitando acumular cambios grandes sin versionar. La convención adoptada sigue el formato Conventional Commits:
...
Criterios para mover tarjetas en el tablero Kanban
El tablero Kanban del proyecto cuenta con las siguientes columnas: Backlog → Por hacer → En progreso → En revisión → Listo. Los criterios acordados para mover una tarjeta de columna son los siguientes:
•	De Backlog a Por hacer: la tarea fue estimada, tiene descripción clara, criterios de aceptación definidos y está asignada a un responsable.
•	De Por hacer a En progreso: el responsable inició activamente el trabajo. Solo puede haber una tarjeta en progreso por integrante (WIP limit = 1 por persona).
•	De En progreso a En revisión: el desarrollo está completo, el código fue commiteado en la rama correspondiente y el Pull Request fue abierto con descripción del cambio.
•	De En revisión a Listo: el Pull Request fue aprobado por al menos un par, mergeado a main, la funcionalidad fue probada por QA y no presenta bugs bloqueantes.

Si una tarjeta permanece más de 48 horas en En revisión sin actividad, el Scrum Master notifica al equipo para desbloquear la situación. Las tarjetas bloqueadas deben marcarse con la etiqueta roja 'Bloqueado' en Trello y adjuntar un comentario explicando el motivo del bloqueo.
